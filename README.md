...
⚡ **Seismic Hazard Assessment Tools:**
  - SQL Query Tool for Vs30 for seismic hazard in Japan (Python) | [sql-query-vs30-japan](https://github.com/MiroHallo/sql-query-vs30-japan)
